...
상세 설계 수치 및 계측 데이터는 `~/stm_board/EXOSUIT_PROTECTION.md` (외부 설계 repo) 참조.
...
## 3. 관련 링크
- **설계 문서**: `~/stm_board/EXOSUIT_PROTECTION.md` (외부 repo)
- **비전 블로그**: [로봇 시스템 보호 설계 리포트](https://blog.naver.com/0xhenry/...)
- **유튜브 스크립트**: `~/stm_board/EP01_robot_hardware_failure.md` (외부 repo)
- **Related (wiki)**: [[exosuit-safety]], [[elmo-driver-comparison]], [[motor-selection]], [[elmo-gold-twitter]], [[can-communication]]
